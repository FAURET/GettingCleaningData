...
### STEP 2
1. by using the function "gather", a variable "label.feature" is created
2. Subject/label.features/label.activity defined as Factor.
3. function by_group and summarise in order to calculate the mean of the features for each triplet (subject/lable.activity/label.feature)
